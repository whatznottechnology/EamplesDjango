...
from .models import BusinessType, BusinessExample

@admin.register(BusinessType)
class BusinessTypeAdmin(admin.ModelAdmin):
    list_display = ('name', 'created_at', 'example_count')
...
@admin.register(BusinessExample)
class BusinessExampleAdmin(admin.ModelAdmin):
