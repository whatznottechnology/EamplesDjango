...
from .models import WebAppType, WebAppDemo

@admin.register(WebAppType)
class WebAppTypeAdmin(admin.ModelAdmin):
...
@admin.register(WebAppDemo)
class WebAppDemoAdmin(admin.ModelAdmin):
    list_display = ('name', 'preview_image', 'link_display', 'created_at', 'tag_list')
    list_filter = ('types', 'tags', 'created_at')
